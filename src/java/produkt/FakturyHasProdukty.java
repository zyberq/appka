...
public class FakturyHasProdukty implements Serializable {
    ...
    public FakturyHasProdukty(int produktyProduktyId, int fakturyFakturyId) {
        this.fakturyHasProduktyPK = new FakturyHasProduktyPK(produktyProduktyId, fakturyFakturyId);
    }
    ...
    public String toString() {
        return "produkt.FakturyHasProdukty[ fakturyHasProduktyPK=" + fakturyHasProduktyPK + " ]";
    }
