...
public class ProduktyHasKategorie implements Serializable {
    ...
    public ProduktyHasKategorie(int kategorieKategorieId, int produktyProduktyId) {
        this.produktyHasKategoriePK = new ProduktyHasKategoriePK(kategorieKategorieId, produktyProduktyId);
    }
    ...
    public String toString() {
        return "produkt.ProduktyHasKategorie[ produktyHasKategoriePK=" + produktyHasKategoriePK + " ]";
    }
