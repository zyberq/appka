...
import produkt.TransakcjaHasProdukty;
import produkt.util.JsfUtil;
import produkt.util.PaginationHelper;
import produkt.TransakcjaHasProduktyFacade;
...
public class TransakcjaHasProduktyController implements Serializable {
    ...
    @EJB
    private produkt.TransakcjaHasProduktyFacade ejbFacade;
    ...
    public TransakcjaHasProdukty getSelected() {
        if (current == null) {
            ...
            current.setTransakcjaHasProduktyPK(new produkt.TransakcjaHasProduktyPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class TransakcjaHasProduktyControllerConverter implements Converter {
        ...
        produkt.TransakcjaHasProduktyPK getKey(String value) {
            produkt.TransakcjaHasProduktyPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new produkt.TransakcjaHasProduktyPK();
            key.setProduktyProduktyId(Integer.parseInt(values[0]));
            key.setTransakcjaTransakcjaId(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(produkt.TransakcjaHasProduktyPK value) {
