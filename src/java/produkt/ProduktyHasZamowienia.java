...
public class ProduktyHasZamowienia implements Serializable {
    ...
    public ProduktyHasZamowienia(int zamowieniaZamowieniaId, int produktyProduktyId) {
        this.produktyHasZamowieniaPK = new ProduktyHasZamowieniaPK(zamowieniaZamowieniaId, produktyProduktyId);
    }
    ...
    public String toString() {
        return "produkt.ProduktyHasZamowienia[ produktyHasZamowieniaPK=" + produktyHasZamowieniaPK + " ]";
    }
