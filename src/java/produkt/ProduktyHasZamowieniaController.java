...
import produkt.ProduktyHasZamowienia;
import produkt.util.JsfUtil;
import produkt.util.PaginationHelper;
import produkt.ProduktyHasZamowieniaFacade;
...
public class ProduktyHasZamowieniaController implements Serializable {
    ...
    @EJB
    private produkt.ProduktyHasZamowieniaFacade ejbFacade;
    ...
    public ProduktyHasZamowienia getSelected() {
        if (current == null) {
            ...
            current.setProduktyHasZamowieniaPK(new produkt.ProduktyHasZamowieniaPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class ProduktyHasZamowieniaControllerConverter implements Converter {
        ...
        produkt.ProduktyHasZamowieniaPK getKey(String value) {
            produkt.ProduktyHasZamowieniaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new produkt.ProduktyHasZamowieniaPK();
            key.setZamowieniaZamowieniaId(Integer.parseInt(values[0]));
            key.setProduktyProduktyId(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(produkt.ProduktyHasZamowieniaPK value) {
